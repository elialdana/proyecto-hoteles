...
<div class="container">
  ...
  <body>
    <div class="class my-10">
        ...
        <br>
        <form action="{{ route('roomTypesNew') }}" method="GET">
                ...
                @foreach($data as $item)
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            <a href="{{ route('roomTypesEdit', $item) }}" class="btn btn-outline-primary btn-sm btn-block">Editar</a>
                            <form action="{{ route('roomTypeDestroy', $item) }}" method="POST">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
