...
<div class="container">
  ...
  <body>
    <div class="class my-10">
        ...
        <br>
        <form action="<?php echo e(route('roomsNew')); ?>" method="GET">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><?php echo e($item->room_number); ?></td>
                    <td><?php echo e($item->price); ?></td>
                    <td><?php echo e($item->roomType->name); ?></td>
                    <td>
                        <div class="btn-group" role="group">
                            <a href="<?php echo e(route('roomTypesEdit', $item)); ?>" class="btn btn-outline-primary btn-sm btn-block">Editar</a>
                            <form action="<?php echo e(route('roomTypeDestroy', $item)); ?>" method="POST">
